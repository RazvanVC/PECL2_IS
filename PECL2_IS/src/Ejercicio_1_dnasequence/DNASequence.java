 ...
 */
package Ejercicio_1_dnasequence;
...
public class DNASequence {
    ...
    /**
    * Constructs the sequence from a String.
    * Nucleotides can be expressed lowercase or uppercase.
    ...
    * @return The number of ocurrences of nucleotide in the
   sequence.
    *
    */
